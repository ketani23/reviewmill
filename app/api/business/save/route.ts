...
export async function POST(req: NextRequest) {
  ...
  if (voice_tone !== undefined && !VALID_VOICE_TONES.includes(voice_tone)) {
  ...
  try {
    await updateBusinessProfile(session.email, {
      ...(business_name !== undefined && { business_name: business_name.trim() }),
      ...(business_type !== undefined && { business_type }),
      ...(voice_tone !== undefined && { voice_tone }),
      ...(custom_instructions !== undefined && { custom_instructions: custom_instructions.trim() }),
      ...(notifications_enabled !== undefined && { notifications_enabled }),
      ...(notification_email !== undefined && { notification_email: notification_email.trim() }),
    });
